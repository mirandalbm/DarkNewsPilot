...
function SidebarContent({ isCollapsed = false, onNavigate }: SidebarContentProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* System Status - Moved back to sidebar as requested */}
      <div className={cn(
        "border-t border-border transition-all duration-300",
        isCollapsed ? "p-2" : "p-4"
      )}>
        {!isCollapsed && (
          <div className="bg-gradient-to-br from-muted/50 to-muted rounded-xl p-4 space-y-3 animate-in slide-in-from-bottom-2 duration-300 mb-4">
